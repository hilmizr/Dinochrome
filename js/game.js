    ...
    this.update = function() {
        ...
        if (self.isJumping) {
            ...
            self.element.position.y = self.jumpHeight * Math.sin(
                ...
                sinusoid(7 * self.stepFreq, 0, 20, 0,
            ...
            self.element.position.y = sinusoid(
                7 * self.stepFreq, 0, 20, 0, runningClock);
            self.head.rotation.x = sinusoid(
                7 * self.stepFreq, -10, -5, 0, runningClock) * deg2Rad;
            self.torso.rotation.x = sinusoid(
                7 * self.stepFreq, -10, -5, 180, runningClock) * deg2Rad;
